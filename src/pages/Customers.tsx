...
function Copyright(props: any) {
  return (
    <Typography
      variant="body2  hello world from customer page"
    ...
    <ThemeProvider theme={defaultTheme}>
      <Box sx={{ display: "flex" }}>
        ...
        <AppBar position="absolute" open={open}>
          ...
          >
            ...
            <IconButton color="inherit" onClick={() => log_out()}>
              ...
              <RiLogoutBoxLine title="Sign Out" style={{ cursor: "pointer" }} />
              {/* </Badge> */}
            </IconButton>
          </Toolbar>
        </AppBar>
        <Drawer variant="permanent" open={open}>
          ...
          >
            <IconButton onClick={() => change("open", !open)}>
              <ChevronLeftIcon />
            </IconButton>
          </Toolbar>
          <Divider />
